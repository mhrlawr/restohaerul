        ...
        axios
            ...
            .then((res) => {
                ...
                swal({
                    ...
                    text: "Update success!" + data.product.nama,
                    icon: "success",
                    button: false,
                    timer: 3000,
                });
        ...
        axios
            ...
            .then((res) => {
                ...
                swal({
                    ...
                    text: "Order deleted!" + this.state.keranjangDetail.product.nama,
                    icon: "error",
                    button: false,
                    timer: 3000,
                });
                            ...
                            {keranjangs.map((menuKeranjang) => (
                                <ListGroup.Item key={menuKeranjang.id} onClick={() => this.handleShow(menuKeranjang)}>
                                    <Row>
                                        <Col xs={1.5}>
                                            <h4>
                                                <Badge pill variant="succes">{menuKeranjang.jumlah}</Badge>
                                            </h4>
                                        </Col>
                                        <Col>
                                            <h8>{menuKeranjang.product.nama}</h8>
